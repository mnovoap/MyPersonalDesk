...
M = importdata('100x100_05_01_20020_Matlab.txt');
                               %0.0004504505  0.0005405405
tam = 100.2882  % 60.17416;   111.3222        %Ingresar Tamano celda;  b<-(a*111.3222)*1000 111.3222 -> 0,00099999999999998
...
i = [72 73 74 75]; % filas --> Y     (47 48 49 50) Lina
j = [33 34 35 36]; % columnas --> X   (43 44 45 46) Lina 
...
%Cargar datos 
Muestras = load('Muestras_SOD.txt'); %1 col numero de muestreo
                                 %2 col O
                                 %3 col N
...
tamano =  0.0009009; %Grados
tamano = tamano*111.32;

Muestras = [Muestras(:,1),(Muestras(:,2)-Oini)*111.32*1000,(Nini-Muestras(:,3))*111.32*1000]; %Transformacion grados a m
...
%%
% Malla SOD
M = importdata('BatimetriaMatlabSOD_2.txt');
